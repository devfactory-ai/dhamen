...
const navigationSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          {
            name: "Tous les bulletins",
            href: "/admin/bulletins",
            icon: DocumentsIcon,
            roles: ["ADMIN"],
          },
          {
            name: "Saisie bulletin",
            href: "/bulletins/saisie",
            icon: PenIcon,
          ...
          {
            name: "Historique",
            href: "/bulletins/history",
            icon: ClockIcon,
            roles: ["INSURER_ADMIN", "INSURER_AGENT"],
          },
          {
            name: "Paiements adhérents",
            href: "/bulletins/payments",
            icon: CurrencyIcon,
            roles: ["INSURER_ADMIN", "INSURER_AGENT"],
            disabled: true,
          },
          {
            name: "Archives bulletins",
            href: "/bulletins/archive",
            icon: ArchiveIcon,
            roles: ["INSURER_ADMIN", "INSURER_AGENT"],
          },
        ],
  ...
  //   items: [
  //     {
  //       name: "Dashboard Santé",
  //       href: "/sante/dashboard",
  //       icon: ChartIcon,
  //       roles: ["ADMIN", "SOIN_GESTIONNAIRE"],
  //       badge: "IA",
  //       disabled: true,
  //     },
  //     {
  //       name: "Analytics",
  //       href: "/sante/analytics",
  //       icon: AnalyticsIcon,
  //       roles: ["ADMIN", "SOIN_GESTIONNAIRE"],
  //     },
  //     {
  ...
  //       href: "/sante/demandes",
  //       icon: HeartIcon,
  //       roles: ["ADMIN", "SOIN_GESTIONNAIRE", "SOIN_AGENT"],
  //     },
  //     {
  //       name: "Bordereaux",
  //       href: "/sante/bordereaux",
  //       icon: DocumentIcon,
  //       roles: ["ADMIN", "SOIN_GESTIONNAIRE"],
  //     },
  //     {
  ...
  //     {
  //       name: "Garanties",
  //       href: "/sante/garanties",
  //       icon: ShieldIcon,
  //       roles: ["ADMIN", "SOIN_GESTIONNAIRE", "INSURER_ADMIN", "INSURER_AGENT"],
  //       disabled: true,
  //     },
  //     {
  //       name: "Workflows",
  //       href: "/sante/workflows",
  //       icon: WorkflowIcon,
  //       roles: ["ADMIN", "SOIN_GESTIONNAIRE", "SOIN_AGENT"],
  //     },
  //     {
  //       name: "Documents",
  //       href: "/sante/documents",
  //       icon: DocumentsIcon,
  //       roles: ["ADMIN", "SOIN_GESTIONNAIRE", "SOIN_AGENT"],
  //     },
  //     {
  ...
  //     {
  //       name: "Mon profil",
  //       href: "/adherent/profile",
  //       icon: UserIcon,
  //       roles: ["ADHERENT"],
  //     },
  //     {
  //       name: "Mon contrat",
  //       href: "/adherent/contract",
  //       icon: DocumentIcon,
  //       roles: ["ADHERENT"],
  //     },
  //     {
  //       name: "Ma consommation",
  //       href: "/adherent/consommation",
  //       icon: ChartIcon,
  //       roles: ["ADHERENT"],
  //     },
  //     {
  //       name: "Mes ayants droit",
  //       href: "/adherent/beneficiaries",
  //       icon: UsersIcon,
  //       roles: ["ADHERENT"],
  //     },
  //     {
  //       name: "Mes bulletins de soins",
  //       href: "/adherent/bulletins",
  //       icon: DocumentsIcon,
  //       roles: ["ADHERENT"],
  //     },
  //     {
  //       name: "Mes remboursements",
  //       href: "/adherent/claims",
  //       icon: ClipboardIcon,
  //       roles: ["ADHERENT"],
  //     },
  //     {
  //       name: "Ma carte virtuelle",
  //       href: "/adherent/card",
  //       icon: CreditCardIcon,
  //       roles: ["ADHERENT"],
  //     },
  //     {
  //       name: "Praticiens de santé",
  //       href: "/adherent/providers",
  //       icon: SearchIcon,
  //       roles: ["ADHERENT"],
  //     },
  //   ],
