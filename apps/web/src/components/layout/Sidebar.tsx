...
const navigation: NavItem[] = [
  ...
  // BI Dashboard
  { name: 'Business Intelligence', href: '/bi', icon: BIIcon, roles: ['ADMIN', 'SOIN_GESTIONNAIRE', 'INSURER_ADMIN'] },
  // Prestataires
  ...
  return (
    ...
    >
      ...
      <div className="flex h-16 items-center gap-3 border-b px-6">
        <div className='flex h-9 w-9 items-center justify-center rounded-lg bg-primary font-bold text-lg text-primary-foreground'>
          D
        </div>
        <span className='font-semibold text-xl'>Dhamen</span>
      </div>
