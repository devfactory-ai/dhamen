...
const SMS_TEMPLATES: Record<string, SmsTemplate> = {
  OTP_LOGIN: {
    ...
    body: 'Dhamen: Votre code de verification est {code}. Valide 5 minutes.',
    variables: ['code'],
    maxLength: 160,
  },
  OTP_RESET: {
    ...
    body: 'Dhamen: Code de reinitialisation: {code}. Ne partagez jamais ce code.',
    variables: ['code'],
    maxLength: 160,
  },
  CLAIM_SUBMITTED: {
    ...
    body: 'Dhamen: Votre demande {numero} a ete soumise. Montant: {montant} TND.',
  ...
  CLAIM_APPROVED: {
    ...
    body: 'Dhamen: Bonne nouvelle! Demande {numero} approuvee. Remb: {montant} TND.',
    variables: ['numero', 'montant'],
    maxLength: 160,
  },
  CLAIM_REJECTED: {
    ...
    body: 'Dhamen: Demande {numero} non approuvee. Motif: {motif}. Contactez-nous.',
  ...
  PAYMENT_SENT: {
    ...
    body: 'Dhamen: Virement de {montant} TND effectue sur votre compte. Ref: {ref}.',
  ...
  FRAUD_ALERT: {
    code: 'FRAUD_ALERT',
    name: 'Alerte fraude',
    body: 'URGENT Dhamen: Activite suspecte detectee. Demande {numero}. Verifiez.',
    variables: ['numero'],
    maxLength: 160,
  },
  CARD_ACTIVATED: {
    code: 'CARD_ACTIVATED',
    name: 'Carte activee',
    body: 'Dhamen: Votre carte virtuelle est active. Code PIN: {pin}. Gardez-le secret.',
    variables: ['pin'],
    maxLength: 160,
  },
  ELIGIBILITY_VERIFIED: {
    ...
    body: 'Dhamen: {adherent} eligibile. Couverture: {taux}%. Plafond dispo: {plafond} TND.',
  ...
  BORDEREAU_READY: {
    ...
    body: 'Dhamen: Bordereau {numero} pret. Montant: {montant} TND. Consultez portail.',
    variables: ['numero', 'montant'],
    maxLength: 160,
  },
};
...
export class SmsService {
  ...
  async send(params: SendSmsParams): Promise<SmsMessage> {
    ...
    const message: SmsMessage = {
      ...
      to: normalizedTo,
      body: messageBody,
      sender: sender || this.config.SMS_SENDER_ID || 'Dhamen',
      templateCode,
      status: 'pending',
      segments,
      retryCount: 0,
