...
export const CARE_TYPE_CONFIG: Record<string, CareTypeEntry> = {
  ...
  actes_courants: {
    label: 'Actes médicaux courants',
    mode: 'compose',
    providerLabel: 'Médecin',
    providerPlaceholder: 'Dr. Mohamed Ali',
    providerType: 'doctor',
    useMedicationAutocomplete: false,
    subItemLabel: 'Actes (PC/AM)',
    showCotation: true,
    descriptionPlaceholder: 'Kinésithérapie, injections...',
    familleCodes: ['FA0009'],
    icon: 'ClipboardList',
  ...
  actes_specialistes: {
    label: 'Actes spécialistes',
    mode: 'compose',
    providerLabel: 'Médecin',
    providerPlaceholder: 'Dr. Mohamed Ali',
    providerType: 'doctor',
    useMedicationAutocomplete: false,
    subItemLabel: 'Actes (Z/E/K)',
    showCotation: true,
    descriptionPlaceholder: 'Radiologie, échographie, physiothérapie...',
    familleCodes: ['FA0017'],
    icon: 'ClipboardList',
    bgColor: 'bg-indigo-50',
    textColor: 'text-indigo-600',
